  ...
  glColor3f(255, 0, 0);
   ...
   int k=0,j=0;
     ...
     while(s>9){
       ...
       // glutBitmapCharacter(font,tmr);

     }

void drawString2(void * font, int s,int spc, float x, float y){
glRasterPos2f(x, y);
...
char buffer[33];
 ...
 //int tmr= chrono::duration_cast<chrono::seconds>(end - start).count() ;
 
//drawString(GLUT_BITMAP_TIMES_ROMAN_24,tmr,10,240,200);

    drawString1(GLUT_BITMAP_TIMES_ROMAN_24,"Score :",100,100);
    
//drawString1(GLUT_BITMAP_TIMES_ROMAN_24,"time :",200,200);
 //drawStrokeText(s,100);
